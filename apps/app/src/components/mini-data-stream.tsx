...
const getPolicyReasoning = (itemTitle: string, t: (content: string) => string) => [
...
const getVendorReasoning = (itemTitle: string, t: (content: string) => string) => [
...
const getRiskReasoning = (itemTitle: string, t: (content: string) => string) => [
...
const getControlReasoning = (itemTitle: string, t: (content: string) => string) => [
...
const getEvidenceReasoning = (itemTitle: string, t: (content: string) => string) => [
  ...
  switch (taskType) {
    case 'policy':
      textFragments.push(getRandomElement(getPolicyReasoning(itemTitle, t)));
      break;
    case 'vendor':
      textFragments.push(getRandomElement(getVendorReasoning(itemTitle, t)));
      break;
    case 'risk':
      textFragments.push(getRandomElement(getRiskReasoning(itemTitle, t)));
      break;
    case 'control':
      textFragments.push(getRandomElement(getControlReasoning(itemTitle, t)));
      break;
    case 'evidence':
      textFragments.push(getRandomElement(getEvidenceReasoning(itemTitle, t)));
      break;
  }
