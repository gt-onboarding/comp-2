    ...
    <div className="mt-24 flex items-center justify-center">
      <div className="flex flex-col items-center">
        ...
        <div className="mb-6 space-y-2 text-center">
          <h2 className="text-lg font-medium">{t('No results found')}</h2>
          <p className="text-muted-foreground text-sm">
            {t('Try another search, or adjusting the filters')}
          </p>
        </div>
  ...
  return (
    <div className="absolute top-0 left-0 z-20 mt-24 flex w-full items-center justify-center">
      <div className="mx-auto flex max-w-sm flex-col items-center justify-center text-center">
        <h2 className="mb-2 text-xl font-medium">{t('No risks yet')}</h2>
        <p className="text-muted-foreground mb-6 text-sm">
          {t('Get started by creating your first risk')}
        </p>
