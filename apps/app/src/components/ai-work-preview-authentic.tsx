...
function getWorkItems(t: ReturnType<typeof useGT>): WorkItem[] {
  return [
    {
      id: '1',
    ...
    <div className="w-full space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground/70">
          {t('{completedCount} of {totalCount} tasks completed • Estimated time remaining: {timeRemaining}', {
            completedCount,
                    ...
                    {isProcessing && (
                      <div className="space-y-2 pl-5">
                        ...
                        <div className="space-y-1">
                          ...
                          >
                            {t('{progress}% complete{finalizing}', {
                              progress: Math.round(item.progress),
                              finalizing: isStuck ? t(' - Finalizing...') : ''
                            })}
                          </p>
                        </div>
                      </div>
