          ...
          <div className="flex items-center justify-between gap-6">
            <div className="flex-1">
              <T>
                <Branch
                  branch={canContinue}
                  true={<p className="text-sm font-medium text-foreground">AI is working in the background (this will take 2-7 minutes)</p>}
                  false={<p className="text-sm font-medium text-foreground">AI workspace setup in progress... (2-7 minutes)</p>}
                />
              </T>
              <T>
                <Branch
                  branch={canContinue}
                  true={<p className="text-xs text-muted-foreground mt-0.5">You can safely continue - we'll notify you when everything is ready</p>}
                  false={<p className="text-xs text-muted-foreground mt-0.5">Analyzing your infrastructure and compliance requirements</p>}
                />
              </T>
            </div>
            <Button
