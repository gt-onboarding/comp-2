  ...
  return (
    <TableHeader>
      <TableRow className="hover:bg-transparent">
        {isVisible('type') && (
          <TableHead className="h-11 px-4 text-left align-middle font-medium"><T>Type</T></TableHead>
        )}
        ...
        {isVisible('status') && (
          <TableHead className="h-11 px-4 text-left align-middle font-medium"><T>Status</T></TableHead>
        )}
      </TableRow>
    </TableHeader>
  );
