    ...
    <aside className="hidden w-full shrink-0 flex-col md:w-64 md:border-l md:pt-8 md:pl-8 lg:flex lg:w-72">
      ...
      <div className="space-y-4 overflow-y-auto">
        ...
        <div className="group flex items-center justify-between text-sm">
          <T><span className="text-muted-foreground">Status</span></T>
        ...
        {/* Assignee Selector */}
        <div className="group flex items-center justify-between text-sm">
          <T><span className="text-muted-foreground">Assignee</span></T>
            ...
            trigger={
              ...
              >
                {assignedMember ? (
                  ...
                  <T><span className="text-muted-foreground">Unassigned</span></T>
                )}
              </Button>
            }
        ...
        {/* Frequency Selector */}
        <div className="group flex items-center justify-between text-sm">
          <T><span className="text-muted-foreground">Frequency</span></T>
        ...
        {/* Department Selector */}
        <div className="group flex items-center justify-between text-sm">
          <T><span className="text-muted-foreground">Department</span></T>
