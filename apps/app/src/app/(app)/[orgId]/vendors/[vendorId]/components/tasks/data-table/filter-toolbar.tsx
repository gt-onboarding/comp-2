        ...
        <div className="flex gap-4">
          <Select value={status ?? 'all'} onValueChange={handleStatusChange}>
            ...
            <SelectContent>
              ...
              <SelectItem value="not_started"><T>Not Started</T></SelectItem>
              <SelectItem value="in_progress"><T>In Progress</T></SelectItem>
          ...
          <Select value={assigneeId ?? 'all'} onValueChange={handleAssigneeChange}>
            ...
            <SelectContent>
              <SelectItem value="all"><T>All Assignees</T></SelectItem>
              {users.map((user) => (
