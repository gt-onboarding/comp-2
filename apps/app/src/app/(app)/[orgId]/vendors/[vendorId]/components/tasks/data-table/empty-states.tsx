    ...
    <div className="flex items-center justify-center">
      <div className="flex flex-col items-center">
        ...
        <div className="mb-6 space-y-2 text-center">
          <T><h2 className="text-lg font-medium">No results found</h2></T>
          {hasFilters ? (
            <T><p className="text-muted-foreground text-sm">Try another search, or adjusting the filters</p></T>
          ) : (
            <T><p className="text-muted-foreground text-sm">Create a task to get started</p></T>
          )}
        </div>
  ...
  return (
    <div className="absolute top-0 left-0 z-20 flex w-full items-center justify-center">
      <div className="mx-auto flex max-w-sm flex-col items-center justify-center text-center">
        <T><h2 className="mb-2 text-xl font-medium">No tasks found</h2></T>
        <T><p className="text-muted-foreground mb-6 text-sm">Create a task to get started</p></T>
