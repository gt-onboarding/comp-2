...
export function CreateVendorForm({ assignees }: { assignees: (Member & { user: User })[] }) {
  ...
  const form = useForm<z.infer<ReturnType<typeof createVendorSchema>>>({
  ...
  const onSubmit = async (data: z.infer<ReturnType<typeof createVendorSchema>>) => {
                                  ...
                                  <div className="max-h-[300px] overflow-y-auto p-1">
                                    ...
                                    {!isSearching &&
                                      ...
                                      searchResults.length === 0 && (
                                        ...
                                        >
                                          {t('Create "{name}"', { name: searchQuery })}
                                        </div>
                                      )}
                                  </div>
                                </div>
